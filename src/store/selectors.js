...
const decorateOrder = (order, tokens) => {
  ...
  // Note: tUSDT should be considered token0, tETH is considered token1
  // Example: Giving tETH in exchange for tUSDT
  if (order.tokenGive === tokens[1].address) {
    token0Amount = order.amountGive; // The amount of tUSDT we are giving
    token1Amount = order.amountGet; // The amount of tETH we want...
  } else {
    token0Amount = order.amountGet; // The amount of tUSDT we want
    token1Amount = order.amountGive; // The amount of tETH we are giving...
  }
